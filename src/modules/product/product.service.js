    ...
    await product.update(
      {
        ...
        category: payload.category !== undefined ? payload.category : product.category,
        subcategory: payload.subcategory !== undefined ? payload.subcategory : product.subcategory,
