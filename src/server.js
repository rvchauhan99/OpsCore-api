...
app.get("/", (req, res) => {
  res.status(200).json({
    status: true,
    message: "OpsCore Manufacturing ERP API is running",
    service: "OpsCore API",
    version: "1.0.0",
  ...
  try {
    ...
    server = httpServer.listen(PORT, () => {
      ...
      if (NODE_ENV === "development" || NODE_ENV === "test") {
        console.log(`
============================================
🏭 \x1b[1m\x1b[32mOpsCore Manufacturing ERP — API Running!\x1b[0m
...
`);
        ...
        console.log(`
============================================
🏭 \x1b[1m\x1b[32mOpsCore Manufacturing ERP — Production Ready!\x1b[0m
💾 Database    : \x1b[34mConnected successfully\x1b[0m
📡 DB Host     : \x1b[36m${host}\x1b[0m
🗂️ DB Name     : \x1b[36m${database}\x1b[0m
👤 DB User     : \x1b[36m${username}\x1b[0m
